# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 12:01:00 2016
...
class ParseHtml:
    def __init__(self, url_file, outfile, url_unparse_file):
        ...
        self._step_p_2nd = '//div[@id="allReplies"]//div[@class="msgBody wrapWord fullMessage"]/descendant::text()'
...
if __name__ == "__main__":
    ph = ParseHtml("C:/Code/data/Dictionary.microsoft.Guide.cb64.txt", "C:/Code/data/SupportMicrosoftParseResult.tsv", "C:/Code/data/SupportMicrosoftUnableParseUrls.tsv")
    ph.Parse()
