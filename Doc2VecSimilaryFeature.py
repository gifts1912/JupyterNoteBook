...
"""
input_filename = r"C:\Code\data\querypassage_trainseed.tsv"
output_filename = r"C:\Code\data\querypassage_trainseed_SemanticScore.tsv"
params_str = "query_field=0, passage_field=2"
query_field = 0
passage_field = 2
"""
...
def TrainDataGenerate(input_filename, query_field, passage_filed):
    ...
    for line in fr:
        ...
        if(len(arr) < max(query_field, passage_field)):
            continue
